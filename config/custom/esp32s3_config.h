...
#pragma message "COMPILING WITH THE MAIN esp32s3_config.h"
...
#define IMU_TYPE ICM42670P
#define USE_ICM42670P_IMU // <- custom IMU
// #define USE_GY85_IMU
...
#define MOTOR_MAX_RPM 450                   // motor's max RPM
#define MAX_RPM_RATIO 0.9                   // max RPM allowed for each MAX_RPM_ALLOWED = MOTOR_MAX_RPM * MAX_RPM_RATIO
#define MOTOR_OPERATING_VOLTAGE 7.4         // motor's operating voltage (used to calculate max RPM)
...
#define COUNTS_PER_REV1 555                 // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 555                 // wheel2 encoder's no of ticks per rev
#define COUNTS_PER_REV3 555                 // wheel3 encoder's no of ticks per rev
#define COUNTS_PER_REV4 555                 // wheel4 encoder's no of ticks per rev
#define WHEEL_DIAMETER 0.055                // wheel's diameter in meters
#define LR_WHEELS_DISTANCE 0.193            // distance between left and right wheels
...
#define BAUDRATE 115200 //to be changed during final deployment to 921600
#define SDA_PIN 40 // specify I2C pins
#define SCL_PIN 39
